...
@section('title', 'Desktop App - Category')
@section('class-navbar', 'bg-primary')
@section('content')
<h1 class="text-center my-5">{{$desktopApp->title}}</h1>
        ...
        <div class="col-md-3 ">
            <div class="card bg-light" style="height: 350px">
                ...
                <div class="card-body">
                    ...
                    <a href="/templates/desktop-app/detail/{{$post->id}}" class="btn btn-primary mt-3 w-100">Read More</a>
                </div>
            </div>
        </div>
    @endforeach
