...
@section('title', 'Hybrid - Category')
@section('content')
<h1 class="text-center my-5">{{$hybrid->title}}</h1>
        ...
        <div class="col-md-3 ">
            <div class="card bg-light" style="height: auto">
                ...
                <div class="card-body">
                    ...
                    <a href="/templates/hybrid/detail/{{$post->id}}" class="btn btn-primary mt-3 w-100">Read More</a>
                </div>
            </div>
        </div>
    @endforeach
